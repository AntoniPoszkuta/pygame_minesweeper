...
fontstyle = os.path.join(__location__,'DeterminationMonoWebRegular-Z5oq.ttf')
...
blank_obraz = pygame.image.load(os.path.join(__location__,'blank_mine.png'))
empty_mine = pygame.image.load(os.path.join(__location__,'empty_mine.png'))
defeat_mine = pygame.image.load(os.path.join(__location__,'defeat_mine.png'))
one_mine = pygame.image.load(os.path.join(__location__,'1_mine.png'))
two_mine = pygame.image.load(os.path.join(__location__,'2_mine.png'))
three_mine = pygame.image.load(os.path.join(__location__,'3_mine.png'))
four_mine = pygame.image.load(os.path.join(__location__,'4_mine.png'))
five_mine = pygame.image.load(os.path.join(__location__,'5_mine.png'))
six_mine = pygame.image.load(os.path.join(__location__,'6_mine.png'))
seven_mine = pygame.image.load(os.path.join(__location__,'7_mine.png'))
eight_mine = pygame.image.load(os.path.join(__location__,'8_mine.png'))
horizontal_frame = pygame.image.load(os.path.join(__location__,'horizontal_frame.png'))
vertical_frame = pygame.image.load(os.path.join(__location__,'vertical_frame.png'))
corner_frame = pygame.image.load(os.path.join(__location__,'corner_frame.png'))
mine = pygame.image.load(os.path.join(__location__,'troll.png'))
exit = pygame.image.load(os.path.join(__location__,'exit.png'))
restartimg = pygame.image.load(os.path.join(__location__,'restart.png'))
backgroundimage = pygame.image.load(os.path.join(__location__,'windows.jfif'))
flag = pygame.image.load(os.path.join(__location__,'flag.png'))
flag_wrong = pygame.image.load(os.path.join(__location__,'flag_wrong.png'))
ok = pygame.image.load(os.path.join(__location__,'ok.png'))
